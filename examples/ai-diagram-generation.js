 ...
 * 2. Run: node examples/ai-diagram-generation.js
 */
...
async function generateDiagramFromTextExample() {
...
async function generateDiagramFromCodeExample() {
  console.log('\nExample 2: Generate a diagram from code using AI');
...
async function generateDiffDiagramExample() {
  console.log('\nExample 3: Generate a diff diagram showing changes between two versions of code');
