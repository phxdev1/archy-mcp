 ...
 * 2. Run: ts-node --esm examples/image-export-and-evolution.ts
 */

import fs from 'fs';
import path from 'path';
import { fileURLToPath } from 'url';
import { exportDiagramInMemory, exportDiagramToDataUrl, ImageFormat, ExportOptions } from '../src/utils/image-exporter.js';
import { InMemoryGit } from '../src/utils/git-memory.js';
...
async function exportDiagramExample(): Promise<void> {
...
async function repositoryEvolutionExample(): Promise<void> {
  console.log('\nExample 2: Track repository evolution');
